export const locales = {
  'zh-TW': {
    ...
    approved: '已核准',
    ocrText: 'OCR 辨識文字',
    ocrNeedsCheck: 'OCR 待確認',
    ocrConfirmed: 'OCR 已確認',
    ocrConfirm: '確認 OCR',
    ocrSaved: 'OCR 校正已確認。',
    ocrReviewerCanFix: '審核可校正 OCR',
  ...
  en: {
    ...
    approved: 'Approved',
    ocrText: 'OCR text',
    ocrNeedsCheck: 'OCR needs check',
    ocrConfirmed: 'OCR confirmed',
    ocrConfirm: 'Confirm OCR',
    ocrSaved: 'OCR correction confirmed.',
    ocrReviewerCanFix: 'Reviewer can correct OCR',
  ...
  ja: {
    ...
    ocrConfirmed: 'OCR 確認済み',
    ocrConfirm: 'OCR 確認',
    ocrSaved: 'OCR 修正を確認しました。',
    ocrReviewerCanFix: '承認者も OCR を修正できます',
  ...
  'zh-CN': {
    ...
    approved: '已核准',
    ocrText: 'OCR 识别文字',
    ocrNeedsCheck: 'OCR 待确认',
    ocrConfirmed: 'OCR 已确认',
    ocrConfirm: '确认 OCR',
    ocrSaved: 'OCR 校正已确认。',
    ocrReviewerCanFix: '审核可校正 OCR',
